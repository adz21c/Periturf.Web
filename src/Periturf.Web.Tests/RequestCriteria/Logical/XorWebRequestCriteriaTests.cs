...
{
    [TestFixture]
    class XorWebRequestCriteriaTests
    {
        [TestCase(true, true, false)]
        [TestCase(true, false, true)]
        [TestCase(false, true, true)]
        [TestCase(false, false, false)]
        public void Given_Criterias_When_Xor_Then_Result(bool criteriaOneResult, bool criteriaTwoResult, bool sutResult)
        {
            ...
            var spec = new XorWebRequestCriteriaSpecification<IWebRequestEvent>();
