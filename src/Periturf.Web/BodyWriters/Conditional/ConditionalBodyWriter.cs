...
{
    class ConditionalBodyWriter : IBodyWriter
    {
        private readonly List<(Func<IWebRequestEvent, bool> Condition, IBodyWriter Writer)> _conditionalWriters;

        public ConditionalBodyWriter(List<(Func<IWebRequestEvent, bool>, IBodyWriter)> conditionalWriters)
        {
