...
{
    class DeserializationBodyReaderSpecification : IWebBodyReaderSpecification, ISerializerConfigurator
    {
        ...
        public IBodyReader Build()
        {
            ...
            return new DeserializationBodyReader(_serializerSpecification.Build());
        }
    }
}
