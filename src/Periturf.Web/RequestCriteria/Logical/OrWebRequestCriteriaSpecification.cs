...
{
    class OrWebRequestCriteriaSpecification<TWebRequestEvent> : IWebRequestCriteriaSpecification<TWebRequestEvent>, IWebRequestCriteriaConfigurator<TWebRequestEvent>
        where TWebRequestEvent : IWebRequestEvent
    {
        ...
        public Func<TWebRequestEvent, bool> Build()
        {
            ...
            return request =>  criterias.Any(x => x(request));
        }
    }
}
