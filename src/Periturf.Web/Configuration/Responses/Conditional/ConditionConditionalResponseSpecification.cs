...
{
    class ConditionConditionalResponseSpecification<TWebRequestEvent> : IConditionConditionalResponseConfigurator<TWebRequestEvent> where TWebRequestEvent : IWebRequestEvent
    {
        private IWebRequestCriteriaSpecification<TWebRequestEvent>? _criteriaSpecification;
        private IWebResponseSpecification<TWebRequestEvent>? _responseSpecification;
        ...
        public void AddWebResponseSpecification(IWebResponseSpecification<TWebRequestEvent> spec)
        {
