...
{
    [TestFixture]
    class VerificationFailedExceptionTests
    {
        [Test]
        public void Given_NoComponentErrors_When_Ctor_Then_ExceptionCreated()
        {
            // Act
            var sut = new VerificationFailedException();
        ...
        public void Given_CustomMessage_When_Ctor_Then_ExceptionCreated()
        {
            ...
            // Act
            var sut = new VerificationFailedException(message);
        ...
        {
            // Arrange
            var originalException = new VerificationFailedException();
            ...
            var deserializedException = (VerificationFailedException)formatter.Deserialize(ms2);
